          ...
          return (
            ...
            >
              <div className="candidate-row__identity">
                ...
                <div className="candidate-row__name">{row.name || "Unknown name"}</div>
              </div>
              ...
              <div className="candidate-row__thesis">
                ...
                <div className="candidate-row__invalidator">{shortText((row.top_invalidators || []).join(" · "), 100) || "No invalidator surfaced."}</div>
