...
OPS_NODE_CATALOG: tuple[OpsNodeMeta, ...] = (
    ...
    OpsNodeMeta("factor:data_quality_factor", "Data Quality Factor", "factor", "factor", "Freshness and readiness quality factor.", upstream_ids=("source:kline", "source:fund_flow", "source:fundamental", "source:events"), downstream_ids=("model:trust", "model:blockers"), replay_jobs=(), can_replay=False),
