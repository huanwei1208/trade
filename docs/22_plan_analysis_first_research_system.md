...
- K-line files: 5,702 symbols, 7,684,146 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 4,328.
- Symbols with latest K-line date equal to `2026-07-09`: 4,322.
...
- Forty-two SH/SZ batches completed with 4,200 requested symbols, 4,200
  successes, 0 failures, 2 empty returns, and 305,376 added rows.
