...
- K-line files: 5,702 symbols, 7,494,904 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 1,736.
- Symbols with latest K-line date equal to `2026-07-09`: 1,735.
...
- Sixteen SH/SZ batches completed with 1,600 requested symbols, 1,600
  successes, 0 failures, 2 empty returns, and 116,134 added rows.
