...
- K-line files: 5,702 symbols, 7,545,864 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 2,435.
- Symbols with latest K-line date equal to `2026-07-09`: 2,433.
...
- Twenty-three SH/SZ batches completed with 2,300 requested symbols, 2,300
  successes, 0 failures, 2 empty returns, and 167,094 added rows.
