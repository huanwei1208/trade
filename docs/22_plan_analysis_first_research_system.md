...
- K-line files: 5,702 symbols, 7,582,333 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 2,935.
- Symbols with latest K-line date equal to `2026-07-09`: 2,932.
...
- Twenty-eight SH/SZ batches completed with 2,800 requested symbols, 2,800
  successes, 0 failures, 2 empty returns, and 203,563 added rows.
