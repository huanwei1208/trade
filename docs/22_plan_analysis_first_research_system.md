...
- K-line files: 5,702 symbols, 7,502,188 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 1,836.
- Symbols with latest K-line date equal to `2026-07-09`: 1,835.
...
- Seventeen SH/SZ batches completed with 1,700 requested symbols, 1,700
  successes, 0 failures, 2 empty returns, and 123,418 added rows.
