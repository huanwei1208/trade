...
- K-line files: 5,702 symbols, 7,480,349 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 1,537.
- Symbols with latest K-line date equal to `2026-07-09`: 1,536.
...
- Fourteen SH/SZ batches completed with 1,400 requested symbols, 1,400
  successes, 0 failures, 2 empty returns, and 101,579 added rows.
