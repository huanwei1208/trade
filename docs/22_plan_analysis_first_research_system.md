...
- K-line files: 5,702 symbols, 7,407,593 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 537.
- Symbols with latest K-line date equal to `2026-07-09`: 536.
...
- Four SH/SZ batches completed with 400 requested symbols, 400 successes, 0
  failures, 2 empty returns, and 28,823 added rows.
