...
- K-line files: 5,702 symbols, 7,691,417 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 4,428.
- Symbols with latest K-line date equal to `2026-07-09`: 4,422.
...
- Forty-three SH/SZ batches completed with 4,300 requested symbols, 4,300
  successes, 0 failures, 2 empty returns, and 312,647 added rows.
