...
- K-line files: 5,702 symbols, 7,516,712 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 2,035.
- Symbols with latest K-line date equal to `2026-07-09`: 2,033.
...
- Nineteen SH/SZ batches completed with 1,900 requested symbols, 1,900
  successes, 0 failures, 2 empty returns, and 137,942 added rows.
