...
- K-line files: 5,702 symbols, 7,647,705 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 3,828.
- Symbols with latest K-line date equal to `2026-07-09`: 3,823.
...
- Thirty-seven SH/SZ batches completed with 3,700 requested symbols, 3,700
  successes, 0 failures, 2 empty returns, and 268,935 added rows.
