...
- K-line files: 5,702 symbols, 7,509,420 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 1,935.
- Symbols with latest K-line date equal to `2026-07-09`: 1,934.
...
- Eighteen SH/SZ batches completed with 1,800 requested symbols, 1,800
  successes, 0 failures, 2 empty returns, and 130,650 added rows.
