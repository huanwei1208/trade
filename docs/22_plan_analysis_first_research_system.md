...
- K-line files: 5,702 symbols, 7,553,148 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 2,535.
- Symbols with latest K-line date equal to `2026-07-09`: 2,533.
...
- Twenty-four SH/SZ batches completed with 2,400 requested symbols, 2,400
  successes, 0 failures, 2 empty returns, and 174,378 added rows.
