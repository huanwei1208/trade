...
- K-line files: 5,702 symbols, 7,698,674 rows, date range
  `2020-01-02 -> 2026-07-09`.
- K-line tracked symbols in `sync_state`: 5,489.
- SH/SZ tracked symbols: 5,191.
- Symbols with latest K-line date on or after `2026-07-01`: 4,527.
- Symbols with latest K-line date equal to `2026-07-09`: 4,521.
...
- Forty-four SH/SZ batches completed with 4,400 requested symbols, 4,400
  successes, 0 failures, 2 empty returns, and 319,904 added rows.
...
- The thirty-seventh batch added 7,290 rows. A unique-symbol watermark check
  found 99 symbols at `2026-07-09`; `601369.SH` remained at `2026-06-26` and
  should be instrument-status checked before repeated retries.
- The thirty-eighth batch added 7,292 rows. A unique-symbol watermark check
  found all 100 symbols at `2026-07-09`.
- The thirty-ninth batch added 7,279 rows. A unique-symbol watermark check
  found all 100 symbols at `2026-07-09`.
- The fortieth batch added 7,292 rows. A unique-symbol watermark check found
  all 100 symbols at `2026-07-09`.
- The forty-first batch added 7,295 rows. A unique-symbol watermark check found
  all 100 symbols at `2026-07-09`.
- The forty-second batch added 7,283 rows. A unique-symbol watermark check found
  99 symbols at `2026-07-09`; `603580.SH` remained at `2026-07-06` and should
  be instrument-status checked before repeated retries.
- The forty-third batch added 7,271 rows. A unique-symbol watermark check found
  all 100 symbols at `2026-07-09`.
- The forty-fourth batch added 7,257 rows. A unique-symbol watermark check
  found 99 symbols at `2026-07-09`; `605081.SH` remained at `2026-06-29` and
  should be instrument-status checked before repeated retries.
