...
final class TradeDbBootstrap {
  ...
  private static void configureSession(Connection connection, TradeDbJdbcUrl options)
      throws SQLException {
  ...
  private static void createTempView(Connection connection, String viewName, String selectSql)
      throws SQLException {
